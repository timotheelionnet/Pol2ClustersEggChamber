...
ect.scatterPlotNucleiMetricBySample('nuc',1,'Volume','');
ect.scatterPlotNucleiMetricBySample('nuc',1,'Mean','wholeImgCorr');

%% scatter plot by egg chamber
% plot where all nuclei from an egg chamber are grouped separately.
ect.scatterPlotNucleiMetricByEggChamber('nuc',1,'Volume','',[6,7,8]); % nuclear Volume

% nuclear mean intensity in DAPI channel (raw)
ect.scatterPlotNucleiMetricByEggChamber('nuc',1,'Mean','raw',[6,7,8]); 

% nuclear mean intensity in DAPI channel 
% (corrected for background estimated across the egg chambers in the image)
ect.scatterPlotNucleiMetricByEggChamber('nuc',1,'Mean','wholeImgCorr','all'); 
ect.scatterPlotNucleiMetricByEggChamber('nuc',1,'Mean','wholeImgCorr',[6,7,8]); 
ect.scatterPlotNucleiMetricByEggChamber('nuc',2,'Mean','wholeImgCorr',[6,7,8]); 
ect.scatterPlotNucleiMetricByEggChamber('nuc',3,'Mean','wholeImgCorr',[6,7,8]); 
ect.scatterPlotNucleiMetricByEggChamber('nuc',4,'Mean','wholeImgCorr',[6,7,8]); 

ect.scatterPlotNucleiMetricByEggChamber('nuc',1,'Median','wholeImgCorr','all'); 
ect.scatterPlotNucleiMetricByEggChamber('nuc',1,'Median','wholeImgCorr',[6,7,8]); 
ect.scatterPlotNucleiMetricByEggChamber('nuc',2,'Median','wholeImgCorr',[6,7,8]); 
ect.scatterPlotNucleiMetricByEggChamber('nuc',3,'Median','wholeImgCorr',[6,7,8]); 
ect.scatterPlotNucleiMetricByEggChamber('nuc',4,'Median','wholeImgCorr',[6,7,8]); 
