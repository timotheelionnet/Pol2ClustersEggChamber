...
switch colorScheme
    ...
    case 'eggChamberID'
        ...
        for i=1:numel(eggChamberID)
            ...
            curColors = cbrewer('seq',curMap,curNnuc+skippedColors);
            nucCmap = [nucCmap;curColors(curNrs.nucID+skippedColors,:)];
        end
end
