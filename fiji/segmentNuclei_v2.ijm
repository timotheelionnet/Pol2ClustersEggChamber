...
macro "segmentNuclei"{
	...
	for (i = 0; i < fileList.length; i++) {
		...
		if(useEggChamberMasks == true){
			...
			if(eggChamberDataFound == 1){
				...
				addChannelToImg(zcorrImgTitle,eggChamberIDsTitle,zcorrImgTitle,1);
	...
	// save text file logging the parameters used for the segmentation.
	parameterSavePath = outFolder+"segmentNuclei_v2_params.txt";
	saveNucleiSegmentationParametersToLogFile(inFolder,outFolder,parameterSavePath,hoechstChannel,
		avgNucleiDiameterInUm,saveInitialSegResults,defaultUseMorphologyFilters,
		minVolume,maxVolume,maxSurfToVolRatio,minSphericity,maxKurtosis,minCV,maxCV);
...
function inputParameters(){
	...
	print("Average Nuclei Diameter (um): ",avgNucleiDiameterInUm);
	...
	print("Min. nucleus Volume (um^3)",minVolume);
	print("Max. nucleus Volume (um^3)",maxVolume);
...
function saveNucleiSegmentationParametersToLogFile(inFolder,outFolder,savePath,hoechstChannel,
	avgNucleiDiameterInUm,saveInitialSegResults,defaultUseMorphologyFilters,
	minVolume,maxVolume,maxSurfToVolRatio,minSphericity,maxKurtosis,minCV,maxCV
	){
	...
	print(f,"segmentNuclei_v2 ended on "+tS+"\r\n");
    print(f,"input Folder: "+inFolder+"\r\n");
    print(f,"output Folder: "+outFolder+"\r\n");
    print(f,"\r\n");
    
    print(f,"****** Nucleus Segmentation Settings:\r\n");
	print(f,"Hoechst color channel: "+hoechstChannel+"\r\n");
	print(f,"Average Nuclei Diameter: "+avgNucleiDiameterInUm+"\r\n");
	print(f,"Save initial segmentation results: "+saveInitialSegResults+"\r\n");
	print(f,"use Morphology Filters: "+useMorphologyFilters+"\r\n");
	print(f,"Min. nucleus Volume (um^3)"+minVolume+"\r\n");
	print(f,"Max. nucleus Volume (um^3)"+maxVolume+"\r\n");
	print(f,"Max. Surface-to-Volume Ratio: "+maxSurfToVolRatio+"\r\n");
	print(f,"Min. Sphericity: "+minSphericity+"\r\n");
	print(f,"Max. Hoechst distribution Kurtosis: "+maxKurtosis+"\r\n");
	print(f,"Min. Hoechst distribution Coeff of Variation"+minCV+"\r\n");
	print(f,"Max. Hoechst distribution Coeff of Variation"+maxCV+"\r\n");
	File.close(f);
}
