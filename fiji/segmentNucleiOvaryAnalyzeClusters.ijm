...
var saveStacks = 0; // hardcoded variable; suggested setting 0; set to 1 to save stacks with only the nucleus segmentation added (these stacks are generated by cropNuclei as an intermediate step redundant with the final output)
